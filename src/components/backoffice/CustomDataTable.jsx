...
export default function CustomDataTable() {
  ...
  return (
    <div className="mt-8 p-8 shadow-xl sm:rounded-lg dark:text-slate-50 text-slate-800 bg-slate-50 dark:bg-slate-700">
      <h2 className="text-xl font-bold mb-4 ">Recent Order</h2>
      {/* table */}
      <div className="relative overflow-x-auto p-8 shadow-md sm:rounded-lg">
        <table className="md:table-fixed sm:table-fixed w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
